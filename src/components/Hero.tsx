...
export default function Hero() {
  return (
    <section className="px-8 pt-10 pb-24 grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-12 items-start">
      <div>
        ...
        <Reveal className="max-w-md">
          ...
          <p className="text-[15px] leading-7 text-white/70 font-regular mb-9">
            My name is Chidalu Ella Ezealigo, a software engineer with a UI/UX design background. Building full stack applications using Java, Spring Boot, Typescript, and  React.
          </p>
     ...
     <Reveal delay={150}>
      <div className="rounded-md w-full aspect-[3/4] overflow-hidden">
        <img 
          src={profile} 
          alt="Profile Picture" 
